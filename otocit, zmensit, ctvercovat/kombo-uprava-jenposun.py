...
INPUT_DIR = r"H:\MachineLearning\OZ_nove datasety_leto2019\_roztridene ruce\_5_ruce_trenovaci_testovaci\01_Rotridene hi-res bez uprav\01_Train\NEART"
OUTPUT_DIR = r"H:\MachineLearning\OZ_nove datasety_leto2019\_roztridene ruce\_5_ruce_trenovaci_testovaci\02_low-res augmentovane\NEART"
            ...
            for uhel_otoceni in uhly:
                ...
                if rozdil_rozmeru == 0:  # rozmery stran jsou stejne, nedelame nic a jdeme na dalsi obrazek
                   ...
                   continue
                    ...
                    upravy = ["doleva", "doprava"]
                    for aktualni_uprava in upravy:

                        if (aktualni_uprava == "doleva"):
                            obrazek_ctvercovy = cv2.copyMakeBorder(obrazek_otoceny, 0, 0, 0,
                                                                   kolik_pridat_na_strane_B + kolik_pridat_na_strane_A, cv2.BORDER_CONSTANT, value=[0, 0, 0])
                            print(
                        ...
                        new_name = nazevSnimkuBezPripony + "_" + aktualni_uprava + pouze_pripona
